...
# include <stdio.h>
# include <intrins.h>
sbit ad9850_w_clk    =9;  //P2.2口接ad9850的w_clk脚/PIN7
sbit ad9850_fq_up    =10;  //P2.1口接ad9850的fq_up脚/PIN8
sbit ad9850_rest     =11;  //P2.0口接ad9850的rest脚/PIN12
sbit ad9850_bit_data =12;  //P1.7口接ad9850的D7脚/PIN25
//P1为8位数据口
//***************************************************//
//              ad9850复位(并口模式)                 //
//---------------------------------------------------//
